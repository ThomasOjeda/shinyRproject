...
computeGeneralMovementRatiosSimple_TEST = function (lowerYear, upperYear, selectedGenre = NULL, selectedOriginUnit = NULL, selectedOriginOffer = NULL,
                                               selectedDestinationUnit = NULL, selectedDestinationOffer = NULL) {
  lowerYear=1
  upperYear=4
  selectedGenre = NULL
  ...
  tb = createStudentMovementTablesVSimple_TEST(lowerYear,upperYear, selectedGenre ,selectedOriginUnit, selectedOriginOffer,
                                          selectedDestinationUnit, selectedDestinationOffer)
