...
loadHumDataset = function () {
  data = readxl::read_excel("humanas.xlsx");
  ...
  saveRDS(student_distribuion_sorted, file = "hum_student_distribution.RDS")
  ...
  saveRDS(h, file = "hum_hashed_data.RDS")
