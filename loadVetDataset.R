...
loadVetDataset = function () {
  data = readxl::read_excel("veterinarias.xlsx");
  
  data = data[,c("...2","CARRERA","SEXO","TIPO","INGRESO","CALIDAD","finales total","INSC CURS","finales aprob año anterior","finales AprobadosActual")]
  
  colnames(data)[1] = "Id ofuscado"
  colnames(data)[7] = "FINALES total"
  ...
  saveRDS(student_distribuion_sorted, file = "vet_student_distribution.RDS")
  ...
  saveRDS(h, file = "vet_hashed_data.RDS")
