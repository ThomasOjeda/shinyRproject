...
loadEcoDataset = function() {
  
  
  data = readxl::read_excel("economicas.xlsx");
  ...
  saveRDS(student_distribuion_sorted, file = "eco_student_distribution.RDS")
  ...
  saveRDS(h, file = "eco_hashed_data.RDS")
