...
loadIngDataset = function() {
  
  
  data = readxl::read_excel("ingenieria.xlsx");
  ...
  saveRDS(student_distribuion_sorted, file = "ing_student_distribution.RDS")
  ...
  saveRDS(h, file = "ing_hashed_data.RDS")
